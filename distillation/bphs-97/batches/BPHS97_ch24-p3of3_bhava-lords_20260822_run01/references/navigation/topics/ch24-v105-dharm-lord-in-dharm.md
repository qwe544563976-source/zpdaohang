...
- 可执行方法：[]
- 候选方法：["ch24-v105-dharm-lord-in-dharm"]
- 事实接入状态：`unmapped`
- 允许执行：`false`
...
- If Dharm’s Lord is in Dharm Bhava, the native will be endowed with abundant fortunes, virtues and beauty and will enjoy much happiness from co-born.
- 九宫主落九宫 福分丰厚与同胞之乐
