---
method: ch28-v10-graha-inauspicious-other-three-places
...
### ch28-v10-graha-inauspicious-other-three-places.step-001
...
- 原文最小意思：行星（Grah）依其落在入旺、Mooltrikon、本星座、大友星座、友星座、中性星座、敌星座、大敌星座、落陷星座（Rāśi）这九种位置定其吉凶；落在其余三种位置时，该行星视为凶。
- 本步骤产出事实：["所考察行星的尊贵位次凶性定性"]
- 所需事实：["所考察行星（Grah）所落星座（Rāśi）的尊贵位次是九种中的哪一种"]
- 条件关系：{"fact_key": "所考察行星（Grah）所落星座（Rāśi）的尊贵位次是九种中的哪一种"}
- 按分支必查事实：[]
- 例外、取消或缓解：[]
- 禁止扩大：["不得据此推断具体灾祸事项、程度或时间。", "原文只说其余三种位置为凶，不得把它改读成行星本身的吉凶星身份。"]
- 来源状态：`single_explicit_source`
...
- 原文证据：
  ...
  - `bphs-97:santhanam:ch28:v10`｜PDF [61]｜“And in the other three places it is inauspicious.”
