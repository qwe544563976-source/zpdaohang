---
method: ch28-v10-graha-neutral-sixth-place
...
### ch28-v10-graha-neutral-sixth-place.step-001
...
- 原文最小意思：行星（Grah）依其落在入旺、Mooltrikon、本星座、大友星座、友星座、中性星座、敌星座、大敌星座、落陷星座（Rāśi）这九种位置定其吉凶；落在第六种位置时，该行星为中性，既不好也不坏。
- 本步骤产出事实：["所考察行星的尊贵位次中性定性"]
- 所需事实：["所考察行星（Grah）所落星座（Rāśi）的尊贵位次是九种中的哪一种"]
- 条件关系：{"fact_key": "所考察行星（Grah）所落星座（Rāśi）的尊贵位次是九种中的哪一种"}
- 按分支必查事实：[]
- 例外、取消或缓解：[]
- 禁止扩大：["中性不等于吉，也不等于凶，不得向任一边靠。", "不得据此推断具体应验事项或时间。"]
- 来源状态：`single_explicit_source`
...
- 原文证据：
  ...
  - `bphs-97:santhanam:ch28:v10`｜PDF [61]｜“In the sixth place it is neutral, i.e. neither good nor bad.”
