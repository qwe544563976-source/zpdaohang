...
# 5岁或9岁成婚：七宫主落吉星宫位、金星入旺或落本星座（own Rāśi）
...
- 动作：先核对七宫主是否落在吉星主管的宫位，再核对金星是入旺还是落本星座（own Rāśi）。
...
- 原文最小意思：七宫主落吉星主管的宫位（原文注：据 Subha Rashi 一说即落九宫），同时金星入旺或落本星座（own Rāśi）时，命主会在5岁或9岁成婚。
- 本步骤产出事实：["第5或9岁成婚判定"]
- 所需事实：["本盘中哪些行星被判为吉星", "七宫主（Yuvati's Lord）是否落吉星主管的宫位（Bhava）"]
- 条件关系：{"operator": "AND", "operands": [{"operator": "AND", "operands": [{"fact_key": "本盘中哪些行星被判为吉星"}, {"fact_key": "七宫主（Yuvati's Lord）是否落吉星主管的宫位（Bhava）"}]}, {"operator": "OR", "operands": [{"fact_key": "金星（Shukra）是否入旺"}, {"fact_key": "金星（Shukra）是否落本星座（own Rāśi）"}]}]}
- 按分支必查事实：[{"when": {"operator": "AND", "operands": [{"fact_key": "本盘中哪些行星被判为吉星"}, {"fact_key": "七宫主（Yuvati's Lord）是否落吉星主管的宫位（Bhava）"}]}, "required_fact_keys": ["金星（Shukra）是否入旺"], "branch_condition_logic": {"fact_key": "金星（Shukra）是否入旺"}, "selection_group": "ch18-v22-marriage-age-5-9.step-001:shukra-dignity", "stop_condition": "选中该分支后，缺少以下事实即停止：金星（Shukra）是否入旺。"}, {"when": {"operator": "AND", "operands": [{"fact_key": "本盘中哪些行星被判为吉星"}, {"fact_key": "七宫主（Yuvati's Lord）是否落吉星主管的宫位（Bhava）"}]}, "required_fact_keys": ["金星（Shukra）是否落本星座（own Rāśi）"], "branch_condition_logic": {"fact_key": "金星（Shukra）是否落本星座（own Rāśi）"}, "selection_group": "ch18-v22-marriage-age-5-9.step-001:shukra-dignity", "stop_condition": "选中该分支后，缺少以下事实即停止：金星（Shukra）是否落本星座（own Rāśi）。"}]
- 例外、取消或缓解：[]
...
- 缺少吉星名册事实时停止。
- 缺少七宫主是否落吉星宫位的事实时停止。
- 金星入旺与落本星座（own Rāśi）两个分支事实都缺时停止。
