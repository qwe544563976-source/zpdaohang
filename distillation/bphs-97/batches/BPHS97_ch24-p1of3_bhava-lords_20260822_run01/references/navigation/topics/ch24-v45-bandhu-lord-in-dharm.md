# 受所有人喜爱、虔信神、有德受尊敬、得每一片快乐的土地：四宫主落九宫（Dharm）
...
- 可执行方法：[]
- 候选方法：["ch24-v45-bandhu-lord-in-dharm"]
- 事实接入状态：`unmapped`
- 允许执行：`false`

## 必查事实

- 四宫主（Bandhu's Lord）是否落九宫（Dharm）
...
- If Bandhu’s Lord is in Dharm Bhava, the native will be dear to one and all, be devoted to God, be virtuous, honourable and endowed with every land of happiness.
- 四宫主落九宫 受所有人喜爱 虔信神 快乐的土地
...
- 缺少四宫主（Bandhu's Lord）是否落九宫（Dharm）的事实时停止。
