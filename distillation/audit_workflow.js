export const meta = {
  ...
  phases: [
    ...
    { title: '实用性与完整性', detail: '这批能不能真当 RAG 路标用；对照本批全部原文查漏和拆分是否恰当' },
  ],
}
...
6. **主题路由会不会串台**？例如问"婚姻"却路由到"六宫疾病"的方法。
   特别注意原文自带的错位：某一章里的偈子讲的其实是别的宫
   （第 1 批实测：第 15 章里有一偈讲的是 Putr 五宫主）。
   这种情况方法有没有如实标注，还是硬归到本章主题？
